...
function create_oauth2_client () {
  ...
  oauth2_client = new OAuth2Client(
    '700648117407-tqauvlf9v8m10nsiu2rm0rltf262s0qb.apps.googleusercontent.com', 
    'VOTAYNq6ZVZSJ_UpQf1T_6Z3',
...
function generate_google_oauth2_url () {
  ...
  var url = oauth2_client.generateAuthUrl({
    ...
    scope: 'https://www.googleapis.com/auth/plus.me' // can be a space-delimited string or array of scopes
  });
  return url;
}
